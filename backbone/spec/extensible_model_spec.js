...
function(chai, _, Backbone, CUT) {
	...
	describe('Backbone Extensible Model', function() {
		...
		describe('validation extension', function() {
			...
			it('should allow easy addition and composition of validation methods', function(){
		...
		describe('initialization extension', function() {
			...
			it('should allow easy addition and composition of initialization methods', function(){
